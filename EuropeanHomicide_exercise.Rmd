...
author: "Anne Sofie Holmgaard Jensen"
...
- How would you characterize the trend compared to the homicides above?
  - In this plot it shows, that the duration of reign is rising over time. The kings were sucedeed by a new king, when they died or were killed. It makes sense if you compare it with the homicides: Fewer homicides in generel - fewer homicides on kings - the kings reigned for a longer time. 

```{r eval = TRUE}

Kings_denmark <- read_csv2("data/kings_1.csv")
...
If we measure the degree of how civilized we are, on how many homicides we commit, the answer is yes. Yes we are more civilized today, because the homicides committed pr. 100,000 individuals is very low in this century compared to the earlier centuries.
